        ...
        <div className="navbar-collapse navbar-collapse-1 collapse" aria-expanded="true">
          ...
          <div className="navbar-form navbar-right">
            ...
            <div className="dropdown user-dropdown">
              <button className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img className="img-circle" src={props.auth.user ? props.auth.user.picture ? ('data:image/jpeg;base64,' + props.auth.user.picture) : "/default_profile_icon.png" : "/default_profile_icon.png"} alt="" /></button>
